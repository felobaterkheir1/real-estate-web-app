      ...
      <nav className="navbarNav">
        <ul className="navbarListItems">
            ...
            <li className="navbarListItem" onClick={() => navigate('/profiles')}>
                <PersonOutlineIcon width='36px' height='36px' fill={pathMatchRoute('/profiles') ? '#2c2c2c' : '#8f8f8f'}/>
                <p className={pathMatchRoute('/profiles') ? 'navbarListItemNameActive' : 'navbarListItemName'}>Profile</p>
            </li>
        </ul>
      </nav>
    </footer>
